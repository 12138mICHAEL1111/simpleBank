...
func TestTransferTx(t *testing.T) {
	...
	// if test is failed, then the db transaction in the rest goroutine which are waiting for writing to channels
	// would be cancelled
	// though all the codes above writing to channels are executed
